...
# Definição da classe Fauna
class Fauna_Filter():
    # Construtor da classe Fauna
    def __init__(self, input_img):
        #Imagem passada pela instancia da classe
    ...
    def Removing_Background(self):
        ...
        rs_util = rs.Resize("background/fauna/filtered_fauna.jpg", self.input_img, "fauna")
        ...
        # Retorna a imagem após todas as operações
        return masked
